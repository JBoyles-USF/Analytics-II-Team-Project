...
\hline
\textbf{Model Type (w/ Best Hyper Parameters)} & \textbf{Split Ratio} & \textbf{FNR} & \textbf{FPR} & \textbf{FN Weight} & \textbf{"FN \& FP Score"} & \textbf{Recall} & \textbf{Precision} & \textbf{F1} & \textbf{F1-Minority} & \textbf{AUC} & \textbf{PR-AUC} \\ \hline
Logistic Regression & & & & & & & & & \\ \hline
Logistic Regression & & & & & & & & & \\ \hline
Logistic Regression & & & & & & & & & \\ \hline
Decision Tree & & & & & & & & & \\ \hline
Balanced RF & & & & & & & & & \\ \hline
XGBoost/LightGBM & & & & & & & & & \\ \hline
\end{tabular}}
